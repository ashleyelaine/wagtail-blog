    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('page_title_override', models.CharField(blank=True, help_text='Use if you would like the page title to be different than what appears in the navigation.', max_length=255)),
                ('intro', models.TextField(blank=True)),
                ('faqs', wagtail.core.fields.StreamField([('FAQ', wagtail.core.blocks.StructBlock([('question', wagtail.core.blocks.CharBlock(classname='title', required=True)), ('answer', wagtail.core.blocks.RichTextBlock())]))], blank=True)),
                ('page_content', wagtail.core.fields.StreamField([('sub_heading_block', wagtail.core.blocks.StructBlock([('sub_heading', wagtail.core.blocks.TextBlock(required=True))])), ('content_block', wagtail.core.blocks.StructBlock([('content', wagtail.core.blocks.RichTextBlock())])), ('cta_block', wagtail.core.blocks.StructBlock([('link', wagtail.core.blocks.CharBlock()), ('link_text', wagtail.core.blocks.CharBlock()), ('target', wagtail.core.blocks.ChoiceBlock(blank=True, choices=[('_self', 'Same Window'), ('_blank', 'New Window')], help_text='Default is Same Window', required=False))])), ('code_block', wagtail.core.blocks.StructBlock([('code', wagtail.core.blocks.StructBlock([('language', wagtail.core.blocks.ChoiceBlock(choices=[('css', 'CSS'), ('html', 'HTML'), ('javascript', 'Javascript'), ('json', 'JSON'), ('python', 'Python'), ('scss', 'SCSS')], help_text='Coding language', identifier='language', label='Language')), ('code', wagtail.core.blocks.TextBlock(identifier='code', label='Code'))], label='Code'))]))], blank=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('addthis_pubid', models.CharField(blank=True, default='5c8fad3d8f2fec06', help_text='This is the string that is AFTER `#pubid=`. Ex: ra-5a61fe428f3a39a8', max_length=25, null=True, verbose_name='AddThis PubId')),
                ('categories', modelcluster.fields.ParentalManyToManyField(blank=True, to='base.BlogCategory')),
            ],
            options={
                'abstract': False,
            },
